...
public class AverageRandoopTest {
    ...
    public void test1() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "AverageRandoopTest.test1");
    ...
    public void test2() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "AverageRandoopTest.test2");
    ...
    public void test3() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "AverageRandoopTest.test3");
        calculations.Average average0 = new calculations.Average();
    ...
    public void test4() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "AverageRandoopTest.test4");
        calculations.Average average0 = new calculations.Average();
    ...
    public void test5() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "AverageRandoopTest.test5");
        calculations.Average average0 = new calculations.Average();
