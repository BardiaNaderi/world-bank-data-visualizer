...
public class Main {
	...
	/**
	 * Demonstration method used to show how the Data Fetchers and Analysis Strategies
	 * work together. One of each of the Analysis subclasses is created by the AnalysisFactory
